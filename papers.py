...
# validate entry attributes (call all of below in this function)
# (checks if attributes complete and in right format)
# passport format
# date format
# name format (both complete, both alpha)
# location (both home and from within list of 12 3-letter country codes (plus KAN))
# reason for entry either returning, transit, or visa
